  ...
  return (
    <header className="px-4 lg:px-6 py-4 lg:py-8 flex flex-col lg:flex-row items-center">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:gap-4 lg:ml-auto">
        ...
        <a className="text-lg font-medium hover:text-rose-800 mb-2 lg:mb-0" href="#" rel="ugc">Shop</a>
      ...
      <div className="flex items-center ml-auto gap-4">
        <div class="relative">
          ...
          <svg
            ...
            class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gra-400 hover:text-rose-900"
          >
