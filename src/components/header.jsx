  ...
  return (
    <header className="px-4 lg:px-6 py-4 lg:py-8 flex flex-col lg:flex-row items-center">
      ...
      <div className="flex items-center ml-auto gap-4">
        ...
        <button onClick={toggleCartModal} className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 w-10 hover:border-rose-800">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
